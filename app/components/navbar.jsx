...
export default function Navbar(initialDelay = 2000) {
  ...
  return (
    <nav className="navbar max-h-[80px] flex justify-center items-center text-[#3E3A39] text-[30px] font-bold fixed top-0 left-0 w-full z-50 p-4 backdrop-blur-[4px] bg-[#F8D4C8]/40">
